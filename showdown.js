	...
	wmd.inputPoller = function(callback, interval){
		...
		this.tick = function(){
            ...
            {		
    			...
    			//resize the height of the input area: much simpler
                if (global.lastInputHeight < inputArea.scrollHeight)
                {
                    global.lastInputHeight = inputArea.scrollHeight + 110;
                    inputArea.style.height = (inputArea.scrollHeight + 100) + "px";
		        }
